  ...
  return (
    ...
    <ScrollView style={{width: '100%', backgroundColor: '#E9E9E9'}}>
      ...
      <View style={{alignItems: 'center'}}>
        ...
        <View style={styles.textbox}>
          <TextInput style={styles.input} onChangeText={setAgency} value={agency} placeholder="Agency"/>
        </View>
        <View style={styles.textbox}>
          <TextInput style={styles.input} onChangeText={setServices} value={services} placeholder="Services"/>
        </View>
