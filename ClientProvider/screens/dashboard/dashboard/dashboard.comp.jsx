  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{marginTop:'25%', width:'100%'}}>
        { noAddress &&
        <TouchableWithoutFeedback onPress={() => navigation.navigate('OptionsStack', { screen:'ProfileAddress', initial:false })}>
        ...
        { noService &&
        <TouchableWithoutFeedback onPress={() => navigation.navigate('OptionsStack', { screen:'ServiceList', initial:false })}>
