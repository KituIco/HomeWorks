...
describe('Portfolio Repository', () => {
    ...
    describe('getServicePortfolios', () => {
        it('should return portfolios given valid serviceID', async () => {
            const portfolios = await portfolioRepo.getServicePortfolios(
                serviceID
            );
        ...
        it('should return error given invalid serviceID and is too long', async () => {
            await expect(
                portfolioRepo.getServicePortfolios('a'.repeat(50))
            ).rejects.toThrow();
        });
    });
});
