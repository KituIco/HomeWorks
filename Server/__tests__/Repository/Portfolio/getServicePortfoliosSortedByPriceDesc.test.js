...
describe('Portfolio Repository', () => {
    ...
    describe('getServicePortfoliosSortedByPriceDesc', () => {
        it('should return sorted portfolios given valid serviceID', async () => {
            const portfolios =
                await portfolioRepo.getServicePortfoliosSortedByPriceDesc(
                    serviceID
                );
        ...
        it('should return error given invalid serviceID and is too long', async () => {
            await expect(
                portfolioRepo.getServicePortfoliosSortedByPriceDesc(
                    'a'.repeat(50)
                )
            ).rejects.toThrow();
        });
