...
describe('Service Repository', () => {
    ...
    describe('getProviderServicesSortedDesc', () => {
        it('should return an array of services given provider', async () => {
            const services = await serviceRepo.getProviderServicesSortedDesc(
                providerID
            );
        ...
        it('should return an error given invalid provider id is too long', async () => {
            await expect(
                serviceRepo.getProviderServicesSortedDesc(nanoid(50))
            ).rejects.toThrow();
        });
    });
});
