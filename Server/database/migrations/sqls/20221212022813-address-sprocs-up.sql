...
BEGIN
    ...
    SET
        ...
        coordinates = COALESCE(POINT(RADIANS(lat), RADIANS(lon)), coordinates),
...
BEGIN
    SELECT DISTINCT
        ...
        ST_Y(Address.coordinates) AS latitude,
        ST_X(Address.coordinates) AS longitude,
